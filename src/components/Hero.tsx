...
import { ArrowRight, CheckCircle2, Star, Sparkles, MessageSquare, Mic, ShieldCheck } from 'lucide-react';
...
export const Hero: React.FC<HeroProps> = ({ onBookClick, onViewCoursesClick }) => {
  return (
    ...
    >
      ...
      <div className="absolute bottom-10 right-10 w-96 h-96 bg-yellow-200/40 rounded-full blur-3xl pointer-events-none" />

      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        <div className="flex flex-col items-center animate-fade-slide">
          
          {/* Top Pill Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-50 text-[#1E40AF] border border-blue-100 mb-6 shadow-xs">
          ...
          {/* Main Headline */}
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-[#1E40AF] tracking-tight leading-[1.1] mb-6">
          ...
          {/* Subheadline */}
          <p className="text-lg sm:text-xl text-slate-600 leading-relaxed font-medium mb-8 max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full sm:w-auto">
            <button
              ...
              id="hero-primary-cta"
              className="inline-flex items-center justify-center gap-3 px-8 py-4 rounded-xl bg-[#FACC15] hover:bg-yellow-500 text-[#1E40AF] font-bold text-lg shadow-lg shadow-yellow-100 hover:scale-[1.02] active:scale-100 transition-all duration-200 focus:outline-none focus:ring-4 focus:ring-yellow-300"
            >
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl bg-white hover:bg-blue-50 text-[#1E40AF] border-2 border-[#1E40AF] font-bold text-lg shadow-xs hover:shadow transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-600"
            >
