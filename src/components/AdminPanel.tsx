...
import { Student, Booking, ClassItem } from '../types';
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 pb-16 font-sans">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4">
        ...
        <div className="bg-gradient-to-r from-[#1E40AF] via-blue-900 to-slate-900 rounded-3xl p-6 sm:p-8 text-white shadow-xl mb-8 relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
            ...
            <button
              ...
              disabled={loadingStudents || loadingClasses}
            ...
            >
              <RefreshCw className={`w-4 h-4 ${(loadingStudents || loadingClasses) ? 'animate-spin' : ''}`} />
        ...
        <div className="flex items-center gap-2 mb-8 bg-slate-200/60 p-1.5 rounded-2xl w-fit">
          <button
